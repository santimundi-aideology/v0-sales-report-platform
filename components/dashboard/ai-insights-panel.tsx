...
const mockInsights: Insight[] = [
  {
    ...
    description: "4 SKUs across Bosnia & Herzegovina and Montenegro are projected to hit zero stock within 2 weeks based on current sell-out velocity.",
    metric: "-15% WoS",
    impact: "high",
  },
  {
    ...
    description: "Kosovo and Albania are running 18% above forecast on accessories. Consider increasing allocation by 500 units.",
    metric: "+28% vs FC",
    impact: "high",
  },
  {
