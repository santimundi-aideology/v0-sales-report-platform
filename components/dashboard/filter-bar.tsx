...
const defaultFilters: FilterConfig[] = [
  {
    ...
    options: [
      ...
      { value: "adriatics", label: "Adriatics" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "datart", label: "Datart.sk" },
      { value: "euronics-hu", label: "Euronics HU" },
      { value: "emag", label: "eMAG.ro" },
      { value: "technomarket", label: "Technomarket" },
      { value: "sancta-domenica", label: "Sancta Domenica" },
      { value: "tehnomanija", label: "Tehnomanija" },
