...
const alerts = [
  {
    ...
    message: "Product B Max stock at Innovate Solutions depleted to 1.8 WoS. Immediate action required.",
  ...
  },
  {
    ...
    message: "3 SKUs in APAC region below minimum safety stock levels.",
    product: "Multiple",
    partner: "Various",
    region: "APAC",
  ...
  },
  {
    ...
    message: "Partner XYZ sell-out trending 15% below forecast for current week.",
  ...
  },
  {
    ...
    message: "Q2 Summer Sale ROI tracking 20% below target in LATAM region.",
  ...
  },
  {
    ...
    message: "Product B Max at NextGen Systems showing 8.2 WoS. Consider rebalancing.",
    product: "Product B Max",
  ...
  },
  {
    ...
    message: "TechCorp Ltd exceeding forecast by 28%. Consider allocation increase.",
